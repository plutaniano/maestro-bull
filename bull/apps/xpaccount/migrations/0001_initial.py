    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "patrimony",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Patrimônio XP"
                    ),
                ),
                (
                    "declared_patrimony",
                ...
                (
                    "fresh",
                    models.BooleanField(
                        default=False, verbose_name="Positions mais atualizada"
                    ),
                ),
                (
                    "queried_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Query na API feita em"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cost",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Custo"
                    ),
                ),
                (
                    "name",
                    models.CharField(max_length=256, verbose_name="Nome da Estrutura"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="Conta XP"
                    ),
                ),
                (
                    "name",
                ...
                (
                    "cpf",
                    models.CharField(default="", max_length=11, verbose_name="CPF"),
                ),
                (
                    "cnpj",
                    models.CharField(default="", max_length=14, verbose_name="CNPJ"),
                ),
                (
                    "cellphone",
                    models.CharField(default="", max_length=32, verbose_name="Celular"),
                ),
                (
                    "phone",
                    models.CharField(
                        default="", max_length=32, verbose_name="Telefone"
                    ),
                ),
                (
                    "email",
                ...
                (
                    "occupation",
                    models.CharField(
                        default="", max_length=128, verbose_name="Ocupação"
                    ),
                ),
                (
                    "state",
                ...
                (
                    "hubspot_id",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="ID HubSpot"
                    ),
                ),
                (
                    "advisor",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "available",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Disponível"
                    ),
                ),
                ...
                (
                    "last_quote",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Última cotação"
                    ),
                ),
                (
                    "position",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Posição"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("ltn", "LTN"),
                            ("ntnb", "NTN-B"),
                            ("ntnb_principal", "NTN-B Principal"),
                            ("ntnc", "NTN-C"),
                            ("ntnf", "NTN-F"),
                        ],
                        max_length=64,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entry_price",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Preço de entrada"
                    ),
                ),
                (
                    "position",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contracted_quantity_position",
                    models.IntegerField(verbose_name="quantidadeContratadaPosicao"),
                ),
                (
                    "contracted_quantity",
                    models.IntegerField(verbose_name="Quantidade contratada"),
                ),
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=256, verbose_name="Descrição"
                    ),
                ),
                (
                    "end_date",
                ...
                (
                    "financial",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Financeiro"
                    ),
                ),
                (
                    "fixing_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Data de fixing"
                    ),
                ),
                (
                    "fixing_type",
                ...
                (
                    "option_type",
                    models.CharField(
                        choices=[("call", "Call"), ("put", "Put"), ("spot", "Spot")],
                        max_length=64,
                        verbose_name="Tipo",
                    ),
                ),
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("active", "Ativa"), ("out_of_spec", "Desenquadrada")],
                        max_length=64,
                        verbose_name="Status",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quote",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Cotação"
                    ),
                ),
                (
                    "financial",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "average_cost_status",
                    models.IntegerField(verbose_name="averageCostStatus"),
                ),
                (
                    "average_cost",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Preço médio"
                    ),
                ),
                (
                    "counterparty_type",
                    models.CharField(
                        choices=[("lender", "Doador"), ("borrower", "Tomador")],
                        max_length=64,
                ...
                (
                    "structured_amount",
                    models.IntegerField(verbose_name="Total estruturado"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity_available",
                    models.IntegerField(verbose_name="Quantidade disponível"),
                ),
                (
                    "quantity_blocked",
                    models.IntegerField(verbose_name="Quantidade bloqueada"),
                ),
                ("quantity_day", models.IntegerField(verbose_name="Quantidade do dia")),
                (
                    "quantity_projected",
                    models.IntegerField(verbose_name="Quantidade projetada"),
                ),
                (
                    "quantity_total",
                    models.IntegerField(verbose_name="Quantidade total"),
                ),
                ("ticker", models.CharField(max_length=64, verbose_name="Ativo")),
                (
                    "parent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "balance",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Saldo"
                    ),
                ),
                ...
                (
                    "contribution",
                    models.CharField(
                        choices=[("sporadic", "Esporádica"), ("monthly", "Mensal")],
                        max_length=64,
                ...
                (
                    "gross_income",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Rendimento bruto"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("boleto", "Boleto"),
                            ("debit", "Débito em Conta Corrente"),
                            ("debit_from_xp_account", "Débito em Conta XP"),
                ...
                (
                    "proposal_code",
                    models.BigIntegerField(verbose_name="Código da proposta"),
                ),
                ...
                (
                    "susep",
                    models.CharField(max_length=32, verbose_name="Processo SUSEP"),
                ),
                (
                    "total_invested",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Total aplicado"
                    ),
                ),
                (
                    "total_rescue",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expiration_code",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Código de vencimento"
                    ),
                ),
                ("expiry_date", models.DateField(verbose_name="Data de vencimento")),
                ...
                (
                    "framing_category",
                    models.IntegerField(
                        choices=[(4, "Four")], verbose_name="Framing Category"
                    ),
                ),
                (
                    "opening_margin_max",
                    models.FloatField(verbose_name="openingMarginMax"),
                ),
                (
                    "opening_unit_price",
                    models.DecimalField(
                ...
                (
                    "settlement_date",
                    models.DateField(verbose_name="Data de liquidação"),
                ),
                (
                    "opening_amount",
                    models.IntegerField(verbose_name="Quantidade/Volume"),
                ),
                (
                    "type",
                    models.CharField(
                        choices=[("swap", "SWAP"), ("put", "Put"), ("call", "Call")],
                        max_length=64,
                        verbose_name="Tipo",
                    ),
                ),
                (
                    "underlying",
                    models.CharField(max_length=64, verbose_name="Ativo objeto"),
                ),
                (
                    "parent",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "strike_price",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Preço do strike"
                    ),
                ),
                (
                    "total_quantity",
                ...
                (
                    "style",
                    models.CharField(
                        choices=[("american", "Americana"), ("european", "Européia")],
                        max_length=32,
                        verbose_name="Tipo",
                    ),
                ),
                (
                    "underlying",
                    models.CharField(max_length=128, verbose_name="Ativo objeto"),
                ),
                (
                    "parent",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("inflation", "Inflação"),
                            ("pre_fixed_income", "Pré-fixado"),
                            ("post_fixed_income", "Pós-fixado"),
                ...
                (
                    "gross_value",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="grossValue"
                    ),
                ),
                ...
                (
                    "iof",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="IOF"
                    ),
                ),
                (
                    "ir",
                ...
                (
                    "withdrawal_liquidation",
                    models.CharField(
                        max_length=256, verbose_name="Resgate (liquidação)"
                    ),
                ),
                (
                    "withdrawal_quota",
                    models.CharField(
                        max_length=256, verbose_name="Resgate (cotização)"
                    ),
                ),
                (
                    "parent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "premium",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Prêmio"
                    ),
                ),
                (
                    "product",
                    models.CharField(max_length=256, verbose_name="Tipo de produto"),
                ),
                ("contract_date", models.DateField(verbose_name="Data de Contrato")),
                (
                    "insurer",
                    models.CharField(max_length=128, verbose_name="Seguradora"),
                ),
                ("insured_capital", models.FloatField(verbose_name="Capital segurado")),
                (
                    "coverage_type",
                    models.IntegerField(verbose_name="Tipo de cobertura"),
                ),
                (
                    "parent",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "refused",
                    models.BooleanField(default=False, verbose_name="Recusado"),
                ),
                (
                    "advisor",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "weight",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Peso (gramas)"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ticker",
                    models.CharField(max_length=128, verbose_name="Instrumento"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lack",
                    models.DateField(blank=True, null=True, verbose_name="Carência"),
                ),
                ...
                (
                    "type_code",
                    models.IntegerField(
                        choices=[(1, 1), (2, 2), (3, 3)], verbose_name="Type Code"
                    ),
                ),
                ...
                (
                    "interest",
                    models.CharField(
                        blank=True, max_length=128, null=True, verbose_name="Juros"
                    ),
                ),
                (
                    "iof",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity_day",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Quantidade do dia"
                    ),
                ),
                (
                    "warranty_bovespa",
                    models.IntegerField(verbose_name="Garantia bovespa"),
                ),
                ("warranty_bvmf", models.IntegerField(verbose_name="Garantia BVMF")),
                (
                    "average_cost_status",
                    models.IntegerField(verbose_name="Status de custo médio"),
                ),
                (
                    "quantity_projected",
                    models.IntegerField(verbose_name="Quantidade projetada"),
                ...
                (
                    "quantity_structured",
                    models.IntegerField(verbose_name="Quantidade estruturado"),
                ),
                (
                    "parent",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "application_date",
                    models.DateField(verbose_name="Data da aplicação"),
                ),
                ("applied_value", models.FloatField(verbose_name="Valor aplicado")),
                ("due_date", models.DateField(verbose_name="Data de vencimento")),
                (
                ...
                (
                    "gross_value",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Valor bruto"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "percent",
                    models.FloatField(verbose_name="Porcento da carteira em saldo"),
                ),
                (
                    "available_balance",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Saldo Disponível"
                    ),
                ),
                (
                    "warranty",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Garantia"
                    ),
                ),
                (
                    "pending_withdrawal_funds",
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=12,
                ...
                (
                    "expiring_terms",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Termos a Vencer"
                    ),
                ),
                (
                    "margin_account",
                ...
                (
                    "projected_balance_1",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Saldo em D+1"
                    ),
                ),
                ...
                (
                    "projected_balance_2",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Saldo em D+2"
                    ),
                ),
                ...
                (
                    "projected_balance_3",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Saldo em D+3"
                    ),
                ),
                ("projected_balance_3_date", models.DateField(verbose_name="Data D+3")),
                (
                    "projected_balance_over",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Saldo em D>3"
                    ),
                ),
                ...
                (
                    "warranty_bmf",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Garantia BM&F"
                    ),
                ),
                (
                    "warranty_bovespa",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Garantia Bovespa"
                    ),
                ),
                (
                    "withdraw_balance",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "asset",
                    models.CharField(max_length=128, verbose_name="Tipo de Produto"),
                ),
                ...
                (
                    "total_quantity",
                    models.IntegerField(verbose_name="Quantidade em Garantia"),
                ),
                (
                    "parent",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "financial_bvmf",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Financeiro BVMF"
                    ),
                ),
                ...
                (
                    "total_financial",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Total Financeiro"
                    ),
                ),
                (
                    "total_quantity",
